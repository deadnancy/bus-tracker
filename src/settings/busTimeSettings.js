...
const busTimeAPI = `https://api.prod.obanyc.com/api/siri/vehicle-monitoring.json?key=${apiKey}&version=2&VehicleMonitoringDetailLevel=${apiDetailLevel}&LineRef=MTA%20NYCT_` // Finished in tracker.
